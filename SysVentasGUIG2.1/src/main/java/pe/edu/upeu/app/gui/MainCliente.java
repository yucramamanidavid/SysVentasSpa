    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (fila != -1) {
            try {
                ...
                if (resultado != 0) {
                    modelo = (DefaultTableModel) jTable1.getModel();
                    Object nuevo[] = {fila + 1, to.getDniruc(), to.getNombresrs(), to.getTipo(), to.getTiempo()};
            ...
            try {
                ...
                if (cDao.create(to) != 0) {
                    modelo = (DefaultTableModel) jTable1.getModel();
                    Object nuevo[] = {modelo.getRowCount() + 1, to.getDniruc(), to.getNombresrs(), to.getTipo(), to.getTiempo()};
                    modelo.addRow(nuevo);
                    resetForm();
                    //JOptionPane.showMessageDialog(this, "Re registro");
                }
